...
import { AdminRole } from "project/types/user.types";
...
export default function CreateAdminUserPage() {
  ...
  const [role, setRole] = useState<AdminRole>(AdminRole.ADMINISTRATOR);
  ...
  return (
    <Container size="md" my="xl">
      <Group justify="space-between" mb="xl">
        <Title order={2}>Crear Nuevo Usuario Administrador</Title>
      </Group>
